                                ...
                                <div class="product-details-img product-single__photos bottom">
                                    <div class="zoompro-wrap product-zoom-right pl-20">
                                        ...
                                        <div class="product-buttons">
                                            <a href="https://www.youtube.com/watch?v=eNm_4w1NANU" class="btn popup-video" title="View Video"><i class="icon anm anm-play-r" aria-hidden="true"></i></a>
                                ...
                                <form method="post" action="?act=cart&xuli=add&id=<?=$data['MaSP']?>" id="product_form_10508262282" accept-charset="UTF-8" class="product-form product-form-product-template hidedropdown" enctype="multipart/form-data">
                                    ...
                                    <div class="product-action clearfix">
                                        ...
                                        <button  type="button" name="add" class="btn product-form__cart-submit">
                                                <span>  
                                                  <input style="color: #ddd;" type="submit" value="Add to cart" >  
                                                            ...
                                                            <form method="post" action="?act=detail&xuli=comment" id="new-review-form" class="new-review-form">
                                                                ...
                                                                <fieldset class="spr-form-contact">
                                                                    <div class="spr-form-contact-name">
                                                                      <label class="spr-form-label" for="review_author_10508262282">Name  (<span class="txt_red" style="color: red;">*</span>)</label>
                                                                      <input type="text" id="ContactFormName" name="name" placeholder=" Enter your name" required="">
                                                                    </div>
                                                                    <div>
                                                                        <div class="form-group"> Email  (<span class="txt_red" style="color: red;">*</span>) 
                                                                            <input type="email" id="ContactFormEmail" name="email" placeholder="john.smith@example.com" required="">
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <fieldset class="spr-form-review">
                                                                  ...
                                                                  <div class="spr-form-review-title">
                                                                    <input type="text" id="ContactFormName" name="name" placeholder="Give your review a title" required="">
                                                                  </div>

                                                                  <div class="spr-form-review-body">
                                                                    <label class="spr-form-label" for="review_body_10508262282">Body of Review <span class="spr-form-review-body-charactersremaining">(350)</span></label>
