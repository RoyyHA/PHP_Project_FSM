                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="?act=shop">Wishlist</a></li>
                            <li><a href="?act=shop">Compare</a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                    ...
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                        ...
                        <ul>
                            <li><a href="?act=contact">Instructions - Support</a></li>
                            <li><a href="?act=contact">FAQ's</a></li>
                            <li><a href="?act=contact">Contact Us</a></li>
                        </ul>
                    </div>
