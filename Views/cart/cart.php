                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 mb-4">
                        	<h5>Estimate Shipping and Tax</h5>
							                <form action="#" method="post">
                                <div class="form-group">
                                    <label for="address_country">province/city</label>
                                    <select id="address_country" name="address" data-default="province">
                                      <option value="---" data-provinces="[]">Please select province/city</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address_zip" name="address[zip]" placeholder="Zip Code..."  required="">
                                </div>
