    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="" action="?act=view-product&run=edit&id=<?= $data['MaSP']?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <img alt="image" class="mr-3 rounded-circle" width="100"
                                     src="../assets/<?= $data['HinhAnh1'] ?>" style="padding-bottom:20px">
                                <input type="file" class="form-control" value="<?= $data['HinhAnh1'] ?>"
                                       name="HinhAnh1">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <img alt="image" class="mr-3 rounded-circle" width="100"
                                     src="../assets/<?= $data['HinhAnh2'] ?>" style="padding-bottom:20px">
                                <input type="file" class="form-control" value="<?= $data['HinhAnh2'] ?>"
                                       name="HinhAnh2">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <img alt="image" class="mr-3 rounded-circle" width="100"
                                     src="../assets/<?= $data['HinhAnh3'] ?>" style="padding-bottom:20px">
                                <input type="file" class="form-control" value="<?= $data['HinhAnh3'] ?>"
                                       name="HinhAnh3">
                            </div>
                        </div>
                        <!-- <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control inputtags" value="<?= $data['MoTa'] ?>"
                                       name="MoTa">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea class="summernote-simple" value="<?= $data['MotaCT'] ?>"
                                          name="MotaCT"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">State</label>
                            <div class="col-sm-12 col-md-7">
                                <select class="form-control selectric" value="<?= $data['TrangThai'] ?>"
                                        name="TrangThai">
